<template>
    <footer class="VPFooter">
      <div class="container">
        <p v-if="theme.footer.icpRecordCode" class="recordCode">
          <span class="icon">
          ...
          <span class="content">
            <a href="https://beian.miit.gov.cn" target="_blank">{{ theme.footer.icpRecordCode }}</a>
          </span>
        </p>
        <p v-if="theme.footer.publicSecurityRecordCode" class="recordCode">
          <span class="icon">
            <img src="https://www.beian.gov.cn/img/new/gongan.png" title="联网备案号">
          </span>
          <span class="content">
            <a :href="'http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=' + theme.footer.publicSecurityRecordCode.replace('号', '').substring(theme.footer.publicSecurityRecordCode.indexOf('备') + 1)" target="_blank">{{ theme.footer.publicSecurityRecordCode }}</a>
          </span>
        </p>
